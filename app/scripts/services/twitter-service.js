...
angular.module('app.services.twitterApp', [])
.factory('twitterService', function($q) {
    ...
    return {
        ...
        getFollowersCount: function () {
        	var deferred = $q.defer();
            var promise = authorizationResult.get('1.1/followers/list.json').done(function(data) { //https://dev.twitter.com/docs/api/1.1/get/statuses/home_timeline
                //when the data is retrieved resolved the deferred object
                deferred.resolve(data)
            });
            //return the promise of the deferred object
